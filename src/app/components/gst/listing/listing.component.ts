...
export class ListingComponent implements OnInit {
  ...
  constructor(
    ...
    const GET_ROLE_API_PERMISSION = `/roles/role/${rolePermission}`;  
      this.httpService.GET(GET_ROLE_API_PERMISSION,{}).subscribe({
        next: (resp: any) => {
          this.addPermission=resp.dashboard_permissions[0].ParentChildchecklist[10].childList[0].isSelected;
          this.editPermission=resp.dashboard_permissions[0].ParentChildchecklist[10].childList[1].isSelected;
          this.deletePermission=resp.dashboard_permissions[0].ParentChildchecklist[10].childList[2].isSelected;
          this.viewPermission=resp.dashboard_permissions[0].ParentChildchecklist[10].childList[3].isSelected;
  ...
  edit(id: any) {
    ...
    {
      this.toast.openSnackBar('Access to GST Master editing is restricted for your account.');
      return;
    }
  ...
  add() {
    ...
    {
      this.toast.openSnackBar('Access to GST Master add is restricted for your account.');
      return;
    }
  ...
  delete(id: any) {
    ...
    {
      this.toast.openSnackBar('Access to GST Master deleting is restricted for your account.');
      return;
    }
